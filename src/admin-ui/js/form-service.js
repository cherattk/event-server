...
function FormService() {
  ...
  return (
    <div className="modal fade" id="serviceForm" tabindex="-1" role="dialog" aria-labelledby="serviceFormLabel" aria-hidden="true">
      <div className="modal-dialog modal-lg" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="serviceFormLabel">
              Service Information
            </h5>
          ...
          <div className="modal-body">
            ...
            <form>
              ...
              <div className="form-group">
                <label for="service-host" className="col-form-label">Host:</label>
